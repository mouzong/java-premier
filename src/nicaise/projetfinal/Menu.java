...
public class Menu {
    ...
    */
    ...
    /**
     * Cette methode affiche l'entete de notre menu accueil de programme
     */

    public static void menuAccueil(){
        System.out.println( """
                Bienvenus dans notre agence de location de biens immobiliers.
               """);
    }

    /**
     * Cette methode affiche l'entete de notre menu nos produits de notre programme
     */

    public static void menuNosProduits(){
        System.out.println( """
                Dans notre agence sont disponibles les chambres et les appartements meublés
               """);
    }
    /**
     * Cette methode affiche l'entete de notre menu nous contacter de notre programme
     */

    public static void menuNousContacter(){
        System.out.println( """
               Nous sommes disponibles au 698 09 78 37
               """);
    }
