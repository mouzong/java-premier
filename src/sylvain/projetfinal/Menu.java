...
public class Menu {
    ...
    public static void menuNosProduits() {
        ...
        System.out.println("\t :::::::::::::::::::::::::::    CHAMBRE MODERNE   ::::::::::::::::::::::::::::");
    ...
    public static void menuAccueil(){
        System.out.println("""
                BIENVENUE CHEZ SIMBA IMMOBILIER,\n
                LA SOLUTION A TOUS VOS PROBLEMES D HENERGEMENT.
    ...
    public static void menuNousContacter(){
        System.out.println("""
                Email : simbaimmo@simba.om,\n
                Téléphone : / 6 73 42 84 01
                site : www.simbaimmobilier.com
